...
To get to know Oiva better, visit our [website](https://oiva-app.github.io/oiva-site/) and [case study](https://oiva-app.github.io/oiva-site/case-study/overview/).

## Using Oiva
- To get started, visit [Oiva's Main Page](https://github.com/oiva-app/oiva)
- To deploy Oiva with ease using our provisioned AWS infrastructure, visit our [Terraform Deployment Guide](https://github.com/oiva-app/oiva/blob/main/terraform/README.md)
